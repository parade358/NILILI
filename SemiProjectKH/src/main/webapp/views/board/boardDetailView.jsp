	...
	<div class="wrap">
       ...
       <!-- 트라이캐치 -->
		...
		<table class="reply-area">
			<tbody id="replywrite">
				<tr>
					<td><input type="text" id="replyinput"
						placeholder="최대 50자까지 작성 가능합니다."></td>
		...
		<div id="footer" align="center">
			...
			<span id="f_text"> 고객문의 | 이용약관 | 개인정보취급방침 | 사이트맵 <br>
			<br> 서울시 영등포구 선유동 2로 57 이레빌딩 20층 E강의장 TEL 1544-9970 <br>
